...
import com.sumu.mobliesafe.service.LockService;
...
public class SettingActivity extends Activity {
    ...
    private SettingItemView sivLock;//程序锁开关
    ...
    private void initLock() {
        ...
        boolean serviceRunning = SystemInfoUtils.isServiceRunning(SettingActivity.this, "com.sumu.mobliesafe.service.LockService");
        sivLock = (SettingItemView) findViewById(R.id.siv_lock);
        sivLock.setChecked(serviceRunning);
        sivLock.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (sivLock.isChecked()) {
                    sivLock.setChecked(false);
                    stopService(new Intent(SettingActivity.this, LockService.class));//停止归属地显示服务
                } else {
                    sivLock.setChecked(true);
                    startService(new Intent(SettingActivity.this, LockService.class));//开启归属地显示服务
                }
            }
        });
    }
